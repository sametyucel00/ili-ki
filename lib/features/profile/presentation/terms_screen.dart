        ...
        child: PrimaryCard(
          child: Column(
            ...
            children: [
              ...
              const Text('Hisle, ilişki iletişimi için AI destekli yorum ve cevap önerileri sunar; terapi, tanı, hukuki değerlendirme veya profesyonel danışmanlık hizmeti değildir.'),
              const SizedBox(height: 12),
              ...
              const SizedBox(height: 12),
              const Text('Taciz, manipülasyon, tehdit, intikam veya zorlayıcı iletişim biçimlerini destekleyen kullanım bu hizmetin amacı dışındadır.'),
